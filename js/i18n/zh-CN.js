...
export default {
  ...
  'battle.log.fireAlliance': '{actor} 开火命中 {target}，对目标造成 {dmg} 点伤害，对同盟护盾造成 {ally} 点伤害',
  'battle.log.fireBlastproof': '{actor} 开火命中 {target}，对目标造成 {dmg} 点伤害，对防爆护盾造成 {ally} 点伤害',
  ...
  'battle.log.blastAlliance': '{actor} 爆炸波及 {target}，对目标造成 {dmg} 伤害，对同盟护盾造成 {ally} 伤害',
  'battle.log.blastBlastproof': '{actor} 爆炸波及 {target}，对目标造成 {dmg} 伤害，对防爆护盾造成 {ally} 伤害',
  'battle.log.shieldBreak': '{ship} 的 {module} 护盾被击破',
  'battle.log.reflect': '{ship} 的护盾反射 {dmg} 伤害给 {attacker}',
